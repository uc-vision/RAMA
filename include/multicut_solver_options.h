...
struct multicut_solver_options {
    ...
    int from_cl(int argc, char** argv) {
        ...
        app.add_option("--preprocessor_threshold", preprocessor_threshold, "Minimum fraction of edges found by the preprocessor to warrant graph contraction. (Default: 0.005).")->check(CLI::Range(0.0, 1.0));
